...
import { api, handleApiError } from "@/lib/firebase-api";
...
function DemosPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return demos.filter(
      (d) =>
        String(d["Business Name"]).toLowerCase().includes(q) ||
        String(d["Demo Link"]).toLowerCase().includes(q),
    );
  }, [demos, search]);
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {filtered
              ...
              .map((d) => (
                <Card
                  key={d["Demo ID"]}
                  className="glass p-5 space-y-3 transition-all hover:-translate-y-0.5 hover:shadow-lg"
                >
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      variant="outline"
                      className="flex-1"
                      onClick={() => window.open(d["Demo Link"], "_blank")}
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      onClick={() => {
                        navigator.clipboard.writeText(d["Demo Link"]);
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            {d["Business Name"]} will be removed.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
